(function() {
    var cordovaRef = window.PhoneGap || window.Cordova || window.cordova || cordova;
    ...
    GAPlugin.prototype.trackEvent = function(success, fail, category, eventAction, eventLabel, eventValue) {
        console.log('GAPlugin trackEvent');
    ...
    GAPlugin.prototype.trackPage = function(success, fail, pageURL) {
        console.log("GAPlugin.prototype.trackPage: " + pageURL);
    ...
    if (cordovaRef) {
        console.log("GAPlugin cordovaRef success");
        if (!window.plugins) {
            window.plugins = {};
        }
        ...
        console.log("GAPlugin cordovaRef error");
    }
